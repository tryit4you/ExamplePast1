...
namespace ExamplePast1.Shared
{
    public static class DataReaderExtensions
    {
        ...
        /// </summary>
        /// <typeparam name="TType">t type</typeparam>
                ...
                for (int index = 0; index < reader.FieldCount; index++)
                {
                    ...
                    if (piList.ContainsKey(name))
                    {
                        ...
                        if ((prop != null) && prop.CanWrite)
                        {
                            ...
                            {
                                val = val.ToString().Trim().Equals("1") ? true : false;
                            }

                            if (prop.PropertyType.Name == "DateTime" || prop.PropertyType.Name == "Nullable`1")
                            {
                                val = (val.ToString() == string.Empty) ? (DateTime?)null : DateTime.Parse(val.ToString());
                            }
